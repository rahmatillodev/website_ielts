import ReadingCardLocked from '@/pages/dashboard/reading/cards/ReadingCardLocked';
...
const ComingSoonPage = () => {
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-start gap-8 py-8 px-6 relative overflow-hidden'>
      {/* Размытый фон */}
      <div className='w-full h-full absolute left-0 top-0 z-100 flex items-center justify-center' 
      style={{
