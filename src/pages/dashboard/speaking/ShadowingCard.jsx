  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        {date ? (
          <div className="flex items-center gap-2 mb-1.5 text-slate-400 text-[10px] font-bold uppercase tracking-wider pointer-events-none">
            <Calendar className="w-3 h-3 shrink-0 text-slate-400" aria-hidden />
            <span className="min-w-0 leading-tight">{date}</span>
          </div>
        ) : null}
        <h2 className="text-lg font-extrabold text-slate-800 mb-3 line-clamp-2 leading-snug group-hover:text-blue-600 transition-colors pointer-events-none md:text-xl">
          {title}
        </h2>
