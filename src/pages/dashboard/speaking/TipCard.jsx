...
export default function TipCard({ data, viewMode = "list" }) {
  ...
  if (isGrid) {
    return (
      <article
        onClick={go}
        className="group flex h-full cursor-pointer flex-col rounded-[2rem] border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-blue-200 hover:shadow-md"
      >
        <div className="flex flex-1 flex-col items-center gap-3 text-center">
          ...
          <div className="min-w-0 space-y-2">
            <div className="flex flex-wrap items-center justify-center gap-2">
              <h3 className="text-lg font-bold text-gray-900 group-hover:text-blue-600">{data.title}</h3>
  ...
  return (
    <article
      onClick={go}
      className="group flex w-full max-w-full flex-row items-center justify-between gap-3 rounded-full border border-gray-200 bg-white px-4 py-3.5 shadow-sm transition-all hover:border-blue-300 hover:shadow-md sm:gap-4 sm:px-5"
    >
      <div className="flex min-w-0 flex-1 items-center gap-3 sm:gap-4">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex min-w-0 flex-wrap items-center gap-2">
            <h3 className="truncate text-base font-bold text-gray-900 group-hover:text-blue-600 md:text-lg">{data.title}</h3>
