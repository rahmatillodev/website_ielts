          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <button
                type="button"
                onClick={handleAvatarClick}
                className="absolute bottom-0 right-0 p-2 bg-primary text-primary-foreground rounded-full border-3 border-white shadow-sm hover:bg-primary-hover transition-all"
              >
